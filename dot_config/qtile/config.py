...
keys = [
         ...
         Key([mod, "shift"], "d",
             lazy.spawn("dmenu_run -bw 2 -l 20 -g 4 -p 'Run: '"),
             desc='Run Launcher'
             ),
         Key([mod], "x",
...
colors = [["#202020", "#202020"], # panel background
          ["#3d3f4b", "#434758"], # background for current screen tab
          ["#e1c135", "#e1c135"], # font color for group names
          ["#ff5555", "#ff5555"], # border line color for current tab
          ["#ffffff", "#ffffff"], # border line color for 'other tabs' and color for 'odd widgets'
          ["#4f76c7", "#4f76c7"], # color for the 'even widgets'
          ["#e8e8d3", "#e8e8d3"], # window name
